...
class Exp:
    ...
    def load_model(self):
        ckp = t.load('./AnyGraph/Models/' + args.load_model + '.mod', weights_only=False)
        self.model = ckp['model']
        self.opt = t.optim.Adam(self.model.parameters(), lr=args.lr, weight_decay=0)

        with open('./AnyGraph/History/' + args.load_model + '.his', 'rb') as fs:
...
if __name__ == '__main__':
    ...
    datasets['link1_part1'] = [
            'products_tech', 'yelp2018', 'yelp_textfeat', 'products_home', 'steam_textfeat', 
    ]
    datasets['link1_part2'] = [
            'amazon_textfeat', 'amazon-book', 'citation-2019','citation-classic', 'pubmed', 
    ]
    datasets['link1_part3'] = [
            'citeseer','ppa', 'p2p-Gnutella06', 'soc-Epinions1', 'email-Enron',
    ]
    ...
    datasets['link2_part2'] = [
            'arxiv-ta', 'cora', 'CS', 'collab','proteins_spec0', 'proteins_spec1', 'proteins_spec2',    
    ]
    datasets['link2_part3'] = [
             'proteins_spec3', 'ddi',
        ]
    datasets['link2_part4'] = [
                'web-Stanford', 'roadNet-PA',
            ]
