...
from node_classification.model import Expert, Feat_Projector, Adj_Projector, AnyGraph
from node_classification.data_handler import MultiDataHandler, DataHandler
import numpy as np
import pickle
import os
import setproctitle
...
if __name__ == '__main__':
    ...
    datasets['div1_part1'] = [
            'products_tech', 'yelp2018', 'yelp_textfeat', 'products_home', 'steam_textfeat', 'amazon_textfeat', 'amazon-book', 'citation-2019',
        ]
    datasets['div1_part2'] = [
            'citation-classic', 'pubmed', 'citeseer', 'ppa', 'p2p-Gnutella06', 'soc-Epinions1', 'email-Enron',
        ]
    ...
    datasets['div2_part1'] = [
            'Photo', 'Goodreads', 'Fitness', 'ml1m', 'ml10m', 'gowalla', 'arxiv', 'arxiv-ta', 'cora',
        ]
    datasets['div2_part2'] = [
            'CS', 'collab', 'proteins_spec0', 'proteins_spec1', 'proteins_spec2', 'proteins_spec3', 'ddi', 'web-Stanford', 'roadNet-PA',
        ]
